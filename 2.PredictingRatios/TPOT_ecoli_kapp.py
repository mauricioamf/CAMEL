...
parameters = {
    ...
    'memory' : None,
    'use_dask' : False,
    'periodic_checkpoint_folder' : 'TPOT_temp_Ecoli_kapp/',
    'early_stop' : None,
    'verbosity' : 3,
    'disable_update_check' : False
    }
    
with open('TPOT_Ecoli_kapp_parameters.txt', 'w') as f:
...
plt.savefig('TPOT_Ecoli_kapp_valid_correlation.jpg', format='jpg', dpi=120)
...
plt.savefig('TPOT_Ecoli_kapp_valid_residuals.jpg', format='jpg', dpi=120)
...
###############################################################################
## Model saving
model.export('TPOT_Ecoli_kapp_exported_pipeline.py')
filename = 'TPOT_Ecoli_kapp_exported_pipeline.sav'
