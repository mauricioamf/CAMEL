...
data = pd.read_csv("trainingdata_Ecoli_kcat_noenv.csv", sep='\t')
...
plt.savefig('TPOT_Ecoli_kcat_noenv_valid_correlation.jpg', format='jpg', dpi=120)
...
plt.savefig('TPOT_Ecoli_kcat_noenv_valid_residuals.jpg', format='jpg', dpi=120)
...
###############################################################################
## Model saving
filename = 'TPOT_Ecoli_kcat_noenv_exported_pipeline.sav'
dump(model, filename)
